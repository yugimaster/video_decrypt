package wei.yuan.video_decrypt.exoplayer.custom;
...
public class MyPlayerView extends FrameLayout implements AdsLoader.AdViewProvider {
     ...
     * <li>{@link SphericalGLSurfaceView} if {@code surface_type} is {@code spherical_view}.
     * <li>{@code null} if {@code surface_type} is {@code none}.
     * </ul>
     *
     * @return The {@link SurfaceView}, {@link TextureView}, {@link SphericalGLSurfaceView} or {@code
     * null}.
     */
